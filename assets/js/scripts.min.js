...
window.textToHtml = function (e) {
    ...
    constructor: SiteFooter, drawLettering: function () {
        console.info("paint");
        var e = $(".site-footer #highfive"), t = $(".site-footer #highfive-shadow");
        $("#highfive-h", e).velocity({strokeDashoffset: 0}, {
            duration: 1500,
            delay: 0,
            easing: "easeInOutQuad"
        }), $("#highfive-H-1", e).velocity({strokeDashoffset: 0}, {
            duration: 300,
            delay: 400,
            easing: "easeInOutQuad"
        }), $("#highfive-H-2", e).velocity({strokeDashoffset: 0}, {
            duration: 300,
            delay: 600,
            easing: "easeInOutQuad"
        }), $("#highfive-ig", e).velocity({strokeDashoffset: 0}, {
            duration: 1e3,
            delay: 600,
            easing: "easeInOutQuad"
        }), $("#highfive-F", e).velocity({strokeDashoffset: 0}, {
            duration: 1e3,
            delay: 1e3,
            easing: "easeOutQuad"
        }), $("#highfive-ive", e).velocity({strokeDashoffset: 0}, {
            duration: 1e3,
            delay: 1e3,
            easing: "easeInOutQuad"
        }), $("#highfive-shadow-h", t).velocity({strokeDashoffset: 0}, {
            duration: 1500,
            delay: 0,
            easing: "easeInOutQuad"
        }), $("#highfive-shadow-H-1", t).velocity({strokeDashoffset: 0}, {
            duration: 300,
            delay: 400,
            easing: "easeInOutQuad"
        }), $("#highfive-shadow-H-2", t).velocity({strokeDashoffset: 0}, {
            duration: 300,
            delay: 600,
            easing: "easeInOutQuad"
        }), $("#highfive-shadow-ig", t).velocity({strokeDashoffset: 0}, {
            duration: 1e3,
            delay: 600,
            easing: "easeInOutQuad"
        }), $("#highfive-shadow-F", t).velocity({strokeDashoffset: 0}, {
            duration: 1e3,
            delay: 1e3,
            easing: "easeOutQuad"
        }), $("#highfive-shadow-ive", t).velocity({strokeDashoffset: 0}, {
            duration: 1e3,
            delay: 1e3,
            easing: "easeInOutQuad"
        })
