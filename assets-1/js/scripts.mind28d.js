...
window.textToHtml = function (e) {
    ...
    constructor: ViewportUnits, initListener: function () {
        $(window).on("resize", this.onWindowResize), this.onWindowResize(null)
    }, onWindowResize: function () {
        $("[data-viewport-height]").each(function () {
            $(this).css({height: $(this).data("viewportHeight") / 100 * $(window).height()})
        }), $("[data-viewport-min-height]").each(function () {
            $(this).css({minHeight: $(this).data("viewportMinHeight") / 100 * $(window).height()})
        }), $("[data-viewport-width]").each(function () {
            $(this).css({width: $(this).data("viewportWidth") / 100 * $(window).height()})
        }), $("[data-viewport-min-width]").each(function () {
            $(this).css({minWidth: $(this).data("viewportMinWidth") / 100 * $(window).height()})
        })
    }, init: function () {
        this.initListener()
    }
}, BlockHero.prototype = {
    constructor: BlockHero, initLettering: function () {
        -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") ? ($("#welcome", $lettering).fadeOut(), $("#welcome-shadow", $lettering).fadeOut()) : ($("#welcome-underline, #welcome-underline-shadow", $lettering).velocity({strokeDashoffset: -275}, {
            duration: 700,
            delay: 0,
            easing: "easeInQuad"
        }), $("#welcome-w, #welcome-w-shadow", $lettering).velocity({strokeDashoffset: -805}, {
            duration: 1400,
            delay: 0,
            easing: "easeInOutQuart"
        }), $("#welcome-e, #welcome-e-shadow", $lettering).velocity({strokeDashoffset: -120}, {
            duration: 1e3,
            delay: 0,
            easing: "easeInOutQuart"
        }), $("#welcome-lcome, #welcome-lcome-shadow", $lettering).velocity({strokeDashoffset: -850}, {
            duration: 1e3,
            delay: 400,
            easing: "easeInOutQuart"
        }), $("#connection-1, #connection-1-shadow", $lettering).velocity({strokeDashoffset: -272}, {
            duration: 600,
            delay: 400,
            easing: "linear"
        }), $("#connection-2, #connection-2-shadow", $lettering).velocity({strokeDashoffset: -235}, {
            duration: 600,
            delay: 700,
            easing: "linear"
        })), $("#md-mv, #md-mv-shadow", $lettering).velocity({strokeDashoffset: -0}, {
            duration: 1500,
            delay: 1e3,
            easing: "easeOutSine"
        }), $("#md-e, #md-e-shadow", $lettering).velocity({strokeDashoffset: -0}, {
            duration: 300,
            delay: 1400,
            easing: "easeInOutQuart"
        }), $("#md-lanie, #md-lanie-shadow", $lettering).velocity({strokeDashoffset: -0}, {
            duration: 1700,
            delay: 1300,
            easing: "easeOutSine"
        }), $("#md-d, #md-d-shadow", $lettering).velocity({strokeDashoffset: -0}, {
            duration: 600,
            delay: 1e3,
            easing: "easeInOutQuart"
        }), $("#md-a, #md-a-shadow", $lettering).velocity({strokeDashoffset: -0}, {
            duration: 300,
            delay: 1400,
            easing: "easeOutSine"
        }), $("#md-eid, md-eid-shadow", $lettering).velocity({strokeDashoffset: -0}, {
            duration: 1e3,
            delay: 1800,
            easing: "easeOutSine"
        }), $("#md-underline, #md-underline-shadow", $lettering).velocity({strokeDashoffset: -0}, {
            duration: 800,
            delay: 2200,
            easing: "easeInOutQuart"
        })
    ...
    constructor: BlockWork, initPlugins: function () {
        $(".project").MDProject()
        ...
        isExpanded && (o = this.closeProject($currentProject, !1)), setTimeout(function () {
            var o = 0;
            Math.floor($(window).scrollTop()) != Math.floor(e.offset().top) && (o = Math.min(1200, Math.max(600, Math.abs($(window).scrollTop() - e.offset().top) / $(window).height() * 600)), console.info(o), $("html,body").animate({scrollTop: e.offset().top}, o, "easeInOutQuart")), setTimeout(function () {
        ...
        var o = 0;
        return $(window).scrollTop() != e.offset().top && (o = Math.min(1200, Math.max(600, ($(window).scrollTop() - e.offset().top) / $(window).height() * 600)), $("html,body").animate({scrollTop: e.offset().top}, o, "easeInOutQuart")), setTimeout(function () {
        ...
        var e = $('.project[data-project="' + $(this).data("project") + '"]'), t = $(this).attr("href");
        ...
        var o = t.$project, i = Math.max(600, ($(window).scrollTop() - $block.offset().top) / $(window).height() * 800);
        $(window).scrollTop() != $block.offset().top && $("html,body").animate({scrollTop: o.offset().top}, i, "easeInOutQuart"), setTimeout(function () {
    ...
    constructor: SiteFooter, onWindowScroll: function () {
        var e = Math.min(1, Math.max(-2, ($(window).scrollTop() - $(".site-wrapper").offset().top) / ($(".site-wrapper").height() - $(window).height())));
        e > .25 , this.isDrawn = !0, $(".site-wrapper [data-ratio]").each(function () {
    ...
    constructor: Overlay, init: function () {
        this.initListener()
    }, initListener: function () {
    ...
    constructor: Fullpage, initListener: function () {
    }, init: function () {
        this.initListener()
    }
}, Chapter.prototype = {
    constructor: Chapter, initPlugins: function () {
        $(".chapter").MDChapter()
    }, init: function () {
        this.initPlugins()
    }
}, Main.prototype = {
    constructor: Main, initPlugins: function () {
        ...
        if ("" != e) {
            ...
            if (t.length) {
                var o = 800;
                return $("html,body").animate({scrollTop: t.offset().top}, o, "easeInOutQuart"), !1
            }
        }
